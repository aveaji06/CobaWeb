                    ...
                    <div className="p-8">
                        ...
                        <div className="grid grid-cols-1 mt-10 2xl:grid-cols-12">
                            <div className="2xl:col-span-5">
                                <p className="mb-2 text-slate-500 dark:text-zink-200">For any inquiries, please contact us at +(252) 0123 456 7890 or reach out via email at bimoo@themesdesign.com.</p>
