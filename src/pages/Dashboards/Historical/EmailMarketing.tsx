...
import { EnvironmentPerformanceChart } from './Charts';
            ...
            <div className="col-span-12 card lg:col-span-6 2xl:col-span-3">
                <div className="card-body">
                    <div className="flex items-center">
                        <h6 className="text-15 grow">ML Performance</h6>
                    ...
                    <EnvironmentPerformanceChart chartId="EnvironmentPerformanceChart" />
                </div>
            </div>
        </React.Fragment>
    );
