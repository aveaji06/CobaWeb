...
import {EmailDataChart, EnvironmentComparisonChart} from './Charts';
            ...
            <div className="col-span-12 card 2xl:col-span-6">
                <div className="card-body">
                    <div className="flex items-center gap-2">
                        <h6 className="text-15 grow">Temperature Data</h6>
                    ...
                    <EnvironmentComparisonChart chartId="environmentDataChart" />
                </div>
            </div>
        </React.Fragment>
    );
