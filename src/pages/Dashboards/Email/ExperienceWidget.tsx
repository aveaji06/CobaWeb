            ...
            <div className="col-span-12 card lg:col-span-6 2xl:col-span-3">
                <div className="flex flex-col h-full card-body">
                    <div className="mb-auto">
                        <h4 className="mb-2">Experience Our Fresh Machine Learning Composition Interface</h4>
                        <p className="mb-5 text-slate-500 dark:text-zink-200">A local-part</p>
                        <Link to="/apps-mailbox" className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                            More Knowladge <ChevronRight/></Link>
                    </div>
                    <div>
