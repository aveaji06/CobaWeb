...
const FarmStatisticsChart = ({ chartId } : any) => {
    ...
    const series = [{
        ...
        data: [120, 110, 150, 160, 180, 170, 190, 200, 210, 220, 230, 240] // Example data for each month
    }, {
        name: 'Egg Production (dozens)',
        data: [300, 320, 310, 330, 340, 350, 360, 370, 380, 390, 400, 410] // Example data for each month
    }];
...
const FeedDistributionChart = ({ chartId } : any) => {
    const chartColors = useChartColors(chartId);

    // Dummy data for Feed Distribution
    const series = [50, 30, 20]; // Corn, Soy, Mixed Grains
    const options : any = {
        chart: {
            height: 222,
            type: 'radialBar',
            ...
            radialBar: {
                dataLabels: {
                    total: {
                        ...
                        label: 'Total',
                        formatter: function () {
                            // Custom formatter to sum the series data
                            return 100; // Assuming total percentage is 100
                        }
                    }
                }
            }
        ...
        colors: chartColors,
        labels: ['Corn Feed', 'Soy Feed', 'Mixed Grains'],
    };
    ...
    return (
        <React.Fragment>
            <ReactApexChart
                ...
                options={options}
                series={series}
                data-chart-colors='["bg-green-500", "bg-purple-500", "bg-yellow-500"]'
                id={chartId}
                className="apex-charts"
                type='radialBar'
                height={222}
...
export default FeedDistributionChart;
