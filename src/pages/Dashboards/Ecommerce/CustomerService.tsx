                    ...
                    <ul className="divide-y divide-slate-200 dark:divide-zink-500">
                        <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zink-200">arthur@bimoo.com</p>
                            </div>
                            <div className="shrink-0">
                                <h6>$2,452</h6>
                            </div>
                        ...
                        <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zink-200">natalie@bimoo.com</p>
                            </div>
                            <div className="shrink-0">
                                <h6>$1,893</h6>
                            </div>
                        ...
                        <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zink-200">jackson@bimoo.com</p>
                            </div>
                            <div className="shrink-0">
                                <h6>$1,196</h6>
                            </div>
                        ...
                        <li className="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                            ...
                            <div className="grow">
                                ...
                                <p className="text-slate-500 dark:text-zink-200">torres@bimoo.com</p>
                            </div>
                            <div className="shrink-0">
                                <h6>$976</h6>
                            </div>
