...
const EnvironmentComparisonChartDO = ({ chartId, selectedDateRange }: any) => {
    ...
    useEffect(() => {
        if (selectedDateRange) {
            const startDate = selectedDateRange[0].toLocaleDateString('id-ID');
            const endDate = selectedDateRange[1].toLocaleDateString('id-ID');
            fetch(`https://ta-ayam-be.vercel.app/api/forensik/DissolvedOxygen?start_date=${startDate}&end_date=${endDate}`)
                .then(res => res.json())
                .then(data => {
...
const EnvironmentComparisonChartEC = ({ chartId, selectedDateRange }: any) => {
    ...
    useEffect(() => {
        if (selectedDateRange) {
            const startDate = selectedDateRange[0].toLocaleDateString('id-ID');
            const endDate = selectedDateRange[1].toLocaleDateString('id-ID');
            fetch(`https://ta-ayam-be.vercel.app/api/forensik/EC?start_date=${startDate}&end_date=${endDate}`)
                .then(res => res.json())
                .then(data => {
...
const EnvironmentComparisonChartSuhuAir = ({ chartId, selectedDateRange }: any) => {
    ...
    useEffect(() => {
        if (selectedDateRange) {
            const startDate = selectedDateRange[0].toLocaleDateString('id-ID');
            const endDate = selectedDateRange[1].toLocaleDateString('id-ID');
            fetch(`https://ta-ayam-be.vercel.app/api/forensik/Temperature?start_date=${startDate}&end_date=${endDate}`)
                .then(res => res.json())
                .then(data => {
...
const EnvironmentComparisonChartpH = ({ chartId, selectedDateRange }: any) => {
    ...
    useEffect(() => {
        if (selectedDateRange) {
            const startDate = selectedDateRange[0].toLocaleDateString('id-ID');
            const endDate = selectedDateRange[1].toLocaleDateString('id-ID');
            fetch(`https://ta-ayam-be.vercel.app/api/forensik/pH?start_date=${startDate}&end_date=${endDate}`)
                .then(res => res.json())
                .then(data => {
...
const EnvironmentComparisonChartMoisture = ({ chartId, selectedDateRange }: any) => {
    ...
    useEffect(() => {
        if (selectedDateRange) {
            const startDate = selectedDateRange[0].toLocaleDateString('id-ID');
            const endDate = selectedDateRange[1].toLocaleDateString('id-ID');
            fetch(`https://ta-ayam-be.vercel.app/api/forensik/Moisture?start_date=${startDate}&end_date=${endDate}`)
                .then(res => res.json())
                .then(data => {
                    console.log("Sensor Data NH3:", data);
                    if (Array.isArray(data)) {
...
const EnvironmentComparisonChartNitrate = ({ chartId, selectedDateRange }: any) => {
    ...
    useEffect(() => {
        if (selectedDateRange) {
            const startDate = selectedDateRange[0].toLocaleDateString('id-ID');
            const endDate = selectedDateRange[1].toLocaleDateString('id-ID');
            fetch(`https://ta-ayam-be.vercel.app/api/forensik/Nitrate?start_date=${startDate}&end_date=${endDate}`)
                .then(res => res.json())
                .then(data => {
...
const EnvironmentComparisonChartNitrogen = ({ chartId, selectedDateRange }: any) => {
    ...
    useEffect(() => {
        if (selectedDateRange) {
            const startDate = selectedDateRange[0].toLocaleDateString('id-ID');
            const endDate = selectedDateRange[1].toLocaleDateString('id-ID');
            fetch(`https://ta-ayam-be.vercel.app/api/forensik/Nitrogen?start_date=${startDate}&end_date=${endDate}`)
                .then(res => res.json())
                .then(data => {
...
const EnvironmentComparisonChartFosfor = ({ chartId, selectedDateRange }: any) => {
    ...
    useEffect(() => {
        if (selectedDateRange) {
            const startDate = selectedDateRange[0].toLocaleDateString('id-ID');
            const endDate = selectedDateRange[1].toLocaleDateString('id-ID');
            fetch(`https://ta-ayam-be.vercel.app/api/forensik/Fosfor?start_date=${startDate}&end_date=${endDate}`)
                .then(res => res.json())
                .then(data => {
...
const EnvironmentComparisonChartSalinity = ({ chartId, selectedDateRange }: any) => {
    ...
    useEffect(() => {
        if (selectedDateRange) {
            const startDate = selectedDateRange[0].toLocaleDateString('id-ID');
            const endDate = selectedDateRange[1].toLocaleDateString('id-ID');
            fetch(`https://ta-ayam-be.vercel.app/api/forensik/Salinity?start_date=${startDate}&end_date=${endDate}`)
                .then(res => res.json())
                .then(data => {
